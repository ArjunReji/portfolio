      ...
      <div className="container mx-auto px-4" ref={contentRef}>
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div ref={linksRef} className="grid grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-4 text-gray-300">
            ...
            <a href="#" className="hover:text-cyan-400 transition duration-300">About</a>
            <a href="#" className="hover:text-cyan-400 transition duration-300">Projects</a>
            <a href="#" className="hover:text-cyan-400 transition duration-300">Contact</a>
            <a href="#" className="hover:text-cyan-400 transition duration-300">Skills</a>
            <a href="#" className="hover:text-cyan-400 transition duration-300">Blog</a>
            <a href="#" className="hover:text-cyan-400 transition duration-300">Resume</a>
            <a href="#" className="hover:text-cyan-400 transition duration-300">Services</a>
          </div>
        </div>
